...
const ChatApp = () => {
  ...
  return (
    <main className="pt-3">
      <div>
        <div className="h-12">
          <span className="px-4 py-2 text-sm whitespace-no-wrap bg-gray-300 border-2 border-r-0 rounded-l dark:border-black dark:bg-gray-700">
            Your ID:
          </span>
          <span
        ...
        <div className="flex">
          <span className="px-4 py-2 text-sm whitespace-no-wrap bg-gray-300 border-2 border-r-0 rounded-l dark:border-black dark:bg-gray-700 dark:text-white-50">
            Partner ID:
          </span>
          <input
            ref={idIn}
