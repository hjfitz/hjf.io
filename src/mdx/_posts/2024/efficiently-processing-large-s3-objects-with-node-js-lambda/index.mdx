---
title: "Efficiently Processing Large S3 Objects with AWS Lambda and Node.js"
...
description: Reading large files from S3 can be a challenge, especially when you're constrained
  to a platform like AWS Lambda, and your language is Node. This post shows how you can 
