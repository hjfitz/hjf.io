...
RS Group, formerly RS Components, is one of the oldest e-commerce websites. They joined the game exceeding early and cemented themselves, rightfully so, as one of the giants. Now moving to a buy-not-build model, it’s losing its key differentiator.
...
Local leadership, however, were full of love, and I’ll always remember this.
