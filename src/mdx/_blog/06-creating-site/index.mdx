...
I've done it again. Created the blog again. From scratch. Again? Kind of. I didn't like my first site. It was made from a template. In early 2020 I tried to rebuild it, but didn't like it. I was also in a bit of a slump, because I didn't like my job. I don't like it now, but I'm getting back in to coding because that's what I want to do. That's a different story, a different post though.

The old site, currently hosted at [hjf.io](https://hjf.io), was from a template: [Lumen](https://www.gatsbyjs.com/starters/alxshelepenok/gatsby-starter-lumen). I liked the template, plenty of white with some black and an accent. Seem familiar?

Recently, I've been toying with Tailwind and MDX. I've also tried Next - didn't like it. I wanted to play with all the tech that I liked and do away with those that I didn't. 
...
![Initial Gatsby terminal setup](./gatsby-term.png)

![Gatsby default starter](./gatsby-default-starter.png)

Now that there is a default Gatsby skeleton running, we're got to add plugins. A lot of plugins. This is the way.
...
On the other hand, I think it pushes a mindset of 'get a library to do it, don't program it'. I don't like the extreme part of this, where everything's just libraries linked. You don't get a lot of control, or understanding of your code. 
...
There's an argument to be made for using libraries and abstraction though. Let's not reinvent the wheel. Unless we can slap a turbo on it.
...
I've not gone mad with plugins this time. I wanted to keep it simple enough to maintain, but give a slick user experience for when I show the site to my mum. 
...
* Working with Netlify functions (To write)
